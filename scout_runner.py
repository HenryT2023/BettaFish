...
THEME_SCHEDULE: Dict[int, Dict] = {
    2:  {"theme": "Deep/Academic",           "track_tier": "premium",
         "keywords_en": ["AI commerce research paper 2026", "cross-border trade white paper released",
                         "McKinsey ecommerce report", "WTO digital trade ruling", "Stanford AI commerce study"],
         "keywords_cn": ["跨境电商研究报告发布", "AI商业白皮书", "数字贸易政策出台", "电商AI论文"]},
    6:  {"theme": "AI Tools & Agent",        "track_tier": "free",
         "keywords_en": ["AI agent product launch this week", "new AI tool release announcement",
                         "OpenAI GPT update today", "Claude Gemini new feature", "AI startup raised funding",
                         "Midjourney Runway update", "AI workflow automation case study"],
         "keywords_cn": ["AI工具新版发布", "AI Agent上线", "大模型更新", "AI创业融资", "AI办公效率实测"]},
    10: {"theme": "Cross-border E-commerce", "track_tier": "free",
         "keywords_en": ["Amazon fee change announcement", "TikTok Shop ban update ruling",
                         "Temu seller policy change", "Shein IPO filing update", "Shopee Lazada layoff",
                         "tariff regulation cross-border ecommerce", "DTC brand acquisition deal"],
         "keywords_cn": ["亚马逊费用调整", "TikTok电商政策", "Temu卖家规则变更", "Shein上市进展", "跨境电商关税新规"]},
    14: {"theme": "SaaS & Digital Trade",    "track_tier": "premium",
         "keywords_en": ["SaaS startup acquisition deal", "B2B platform shutdown pivot",
                         "supply chain software raised series", "ERP vendor price change",
                         "trade compliance regulation update", "Shopify BigCommerce feature launch"],
         "keywords_cn": ["SaaS公司收购", "B2B平台转型", "供应链软件融资", "外贸ERP价格调整", "电商SaaS新功能"]},
    18: {"theme": "Crypto & Web3",           "track_tier": "premium",
         "keywords_en": ["SEC crypto ruling today", "stablecoin regulation passed",
                         "crypto exchange hack breach", "Bitcoin ETF inflow record",
                         "CBDC cross-border payment pilot launch", "DeFi protocol exploit"],
         "keywords_cn": ["加密货币监管裁决", "稳定币法案通过", "交易所安全事件", "比特币ETF资金流入", "数字人民币跨境试点"]},
    22: {"theme": "General Tech",            "track_tier": "free",
         "keywords_en": ["Product Hunt top launch today", "tech company layoff announcement",
                         "Apple Google Microsoft announcement this week", "startup demo day YC batch",
                         "developer tool launch Product Hunt", "consumer hardware teardown review"],
         "keywords_cn": ["科技公司裁员", "苹果谷歌微软发布", "YC创业公司", "新品拆解评测", "开发者工具上线"]},
}
